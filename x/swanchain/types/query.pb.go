...
// source: swanchain/swanchain/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_1f8fc25ea72aaed8, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_1f8fc25ea72aaed8, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "swanchain.swanchain.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "swanchain.swanchain.QueryParamsResponse")
}

func init() { proto.RegisterFile("swanchain/swanchain/query.proto", fileDescriptor_1f8fc25ea72aaed8) }

var fileDescriptor_1f8fc25ea72aaed8 = []byte{
	// 282 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x2f, 0x2e, 0x4f, 0xcc,
	...
	0xff, 0xff, 0x33, 0x80, 0x8b, 0xd7, 0xec, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/swanchain.swanchain.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/swanchain.swanchain.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "swanchain.swanchain.Query",
	...
	Metadata: "swanchain/swanchain/query.proto",
}
